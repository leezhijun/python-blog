...
blog_user = sa.Table('blog_user', metadata,
    ...
    sa.Column('user_registered_time', sa.Time, nullable=False),
    sa.Column('user_birthday', sa.Date),
    sa.Column('user_last_login_time', sa.Time, nullable=False),
...
#     sa.Column('article_publish_time', sa.Time, nullable=False),
#     sa.Column('article_update_time', sa.Time, nullable=False),
